...
MODEL_ARGS="pretrained=$MODEL,dtype=bfloat16,max_model_length=4096,gpu_memory_utilization=0.75,generation_parameters={max_new_tokens:4096,temperature:0.6,top_p:0.95}"
